...
var ImageBlock = exports.ImageBlock = /*#__PURE__*/function (_Block2) {
  ...
  return _createClass(ImageBlock, [{
    ...
    value: function toHTML() {
      ...
      return (0, _utils.row)("<img src=\"".concat(this.value, "\" alt=\"").concat(alt, "\" imageStyles=\"").concat((0, _utils.css)(is), "\" />"), (0, _utils.css)(styles));
    }
  }]);
}(Block);
...
var TextBlock = exports.TextBlock = /*#__PURE__*/function (_Block4) {
  ...
  return _createClass(TextBlock, [{
    key: "toHTML",
    value: function toHTML() {
      var temp = (0, _utils.css)(this.options.styles);
      console.log(temp);
      return (0, _utils.row)((0, _utils.col)("<p> ".concat(this.value, "</p>")), temp);
    }
  }]);
}(Block);
...
var text = "\u0412\u0447\u0456\u043C\u043E JavaScript. JavaScript - \u0446\u0435 \u043A\u0440\u0443\u0442\u043E. \u0420\u0430\u0437\u043E\u043C \u0434\u043E \u043F\u0435\u0440\u0435\u043C\u043E\u0433\u0438.";
var model = exports.model = [new _blocks.TitleBlock("Конструктор сайтів на чистому JavaScript.", {
  tag: "h2",
  styles: {
  ...
  alt: "image"
}), new _blocks.ColumnsBlock(["Додаток на чистому JavaScript, без використання бібліотек.", "Дізнаєшся як працює принцип SOLID и ООП в JavaScript за один курс.", "JavaScript - це просто та цікаво. Навчися створювати будь-які UI своїми руками."], {
  styles: {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "56157" + '/');
